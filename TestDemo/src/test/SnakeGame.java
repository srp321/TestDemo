	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < T; i++) {
				...
				if (Len - 1 != seq.length()) {
					throw new Exception("Wrong length and corresponding direction values given;" + " Original Length: "
							+ Len + "; Current Length by Direction: " + (seq.length() + 1));
				}
				...
				// Checking for next each directions/positions where snake can
				// move
